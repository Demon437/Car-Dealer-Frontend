...
const MarkSoldModal = ({ car: initialCar, onClose, onSuccess }: MarkSoldModalProps) => {
    ...
    // 🔥 loan part
    const loanAmountNum = formData.paymentType === "LOAN" ? Number(formData.loanAmount || 0) : 0;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (
            formData.insuranceStatus !== "PENDING" &&
        ...
        try {
            ...
            if (formData.buyerPhoto)
                fd.append("buyerPhoto", formData.buyerPhoto);
            ...
            fd.append(
                "extraAdminExpenses",
                JSON.stringify(formData.extraAdminExpenses.filter(e => e.label && e.amount))
            );
                    ...
                    {!fetching && (
                        <>
                                ...
                                <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <p className="font-semibold">{car.seller.name || "N/A"}</p>
                                        </div>
                                        <div>
                                            <p className="text-gray-600">Phone</p>
                                            <p className="font-semibold">{car.seller.phone || "N/A"}</p>
                                        </div>
                                        {car.seller.altPhone && (
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="font-semibold">{car.seller.city || "N/A"}</p>
                                        </div>
                                        {car.seller.area && (
                                            <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <form id="markSoldForm" onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-xl space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium mb-2">Buyer Phone *</label>
                                                <input
                                                    type="tel"
                                                    name="buyerPhone"
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium mb-2">Buyer City</label>
                                                <input
                                                    type="text"
                                                    name="buyerCity"
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-xl space-y-4">
                                        <h4 className="font-medium text-yellow-900">RTO Documents</h4>
                                    ...
                                    <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl space-y-5">
                                        ...
                                        <div className="space-y-3">
                                            <h5 className="font-medium text-slate-800">RC Transfer</h5>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <select
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, rcTransferStatus: e.target.value }))
                                                    }
                                                >
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, rcTransferDate: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, newOwnerName: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, rcTransferCharges: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                            </div>
                                        ...
                                        {/* RTO CHANGE */}
                                        <div className="space-y-3">
                                            <h5 className="font-medium text-slate-800">RTO / Number Change</h5>

                                            <select
                                                className="border rounded-lg px-3 py-2"
                                                value={formData.rtoChange}
                                                onChange={(e) =>
                                                    setFormData((p) => ({ ...p, rtoChange: e.target.value }))
                                                }
                                            >
                                            ...
                                            {formData.rtoChange === "YES" && (
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setFormData((p) => ({ ...p, oldRto: e.target.value }))
                                                        }
                                                        className="border rounded-lg px-3 py-2"
                                                    />
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setFormData((p) => ({ ...p, newRto: e.target.value }))
                                                        }
                                                        className="border rounded-lg px-3 py-2"
                                                    />
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) =>
                                                            setFormData((p) => ({ ...p, rtoCharges: e.target.value }))
                                                        }
                                                        className="border rounded-lg px-3 py-2"
                                                    />
                                                </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) =>
                                                    setFormData((p) => ({ ...p, insuranceStatus: e.target.value }))
                                                }
                                            >
                                                <option value="PENDING">Pending</option>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, insuranceCompany: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, policyNumber: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setFormData((p) => ({ ...p, insuranceCharges: e.target.value }))
                                                    }
                                                    className="border rounded-lg px-3 py-2"
                                                />
                                            </div>
                                    ...
                                    <div className="bg-green-50 border border-green-200 p-5 rounded-xl space-y-5">
                                        ...
                                        {formData.paymentType === "LOAN" && (
                                            <>
                                                ...
                                                <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg space-y-4">
                                                    <h5 className="font-medium text-blue-900">🏦 Loan Details</h5>
                                                ...
                                                <div className="bg-white p-4 rounded-lg border space-y-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select
                                                            ...
                                                            onChange={(e) =>
                                                                setFormData((p) => ({ ...p, cashPaymentMode: e.target.value }))
                                                            }
                                                            className="w-full px-4 py-2 border rounded-lg bg-white"
                                                        >
                                        ...
                                        <div className="bg-white p-4 rounded-lg border text-sm space-y-2">
                                            ...
                                            <div className="flex justify-between font-semibold">
                                                ...
                                                <span className={totalRemaining > 0 ? "text-red-600" : "text-green-700"}>
                                    ...
                                    <div className="bg-gray-50 border p-4 rounded-lg space-y-3">
                                            ...
                                            <div key={i} className="flex gap-3">
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        setFormData((p) => ({ ...p, extraAdminExpenses: copy }));
                                                    }}
                                                />
                                                <input
                                                    type="number"
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                setFormData((p) => ({
                                                    ...p,
                                                    extraAdminExpenses: [...p.extraAdminExpenses, { label: "", amount: "" }],
                                                }))
                                            }
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <Button type="submit" disabled={loading} className="flex-1 bg-green-600 text-white">
