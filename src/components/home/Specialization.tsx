...
export const Specialization = () => (
  <section className="py-20 bg-[#F6F7F9]">
    ...
    {/* Section Heading */}
    <div className="max-w-7xl mx-auto px-6 xl:px-0 text-center mb-14">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
        Browse by Category
      </h2>
      <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
        Discover vehicles across carefully selected categories to match every lifestyle and need.
      </p>
    </div>

    {/* Cards Grid */}
    <div className="max-w-7xl mx-auto px-6 xl:px-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {specializations.map((spec) => (
        <motion.div
          key={spec.title}
          whileHover={{ y: -10 }} 
          className="bg-white p-8 rounded-2xl border border-gray-200 text-center transition-shadow hover:shadow-md"
        >
